...
get_filename_component(_realOrig "/usr/lib/llvm-7/lib/cmake/llvm" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/llvm-7/lib/cmake/llvm")
endif()
unset(_realOrig)
unset(_realCurr)
...
set_target_properties(LLVMAVRCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAVRAsmPrinter;LLVMAVRDesc;LLVMAVRInfo;LLVMAsmPrinter;LLVMCodeGen;LLVMCore;LLVMMC;LLVMSelectionDAG;LLVMSupport;LLVMTarget"
)
...
# Create imported target LLVMAVRAsmPrinter
add_library(LLVMAVRAsmPrinter STATIC IMPORTED)
...
set_target_properties(LLVMAVRDesc PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAVRAsmPrinter;LLVMAVRInfo;LLVMMC;LLVMSupport"
)
...
set_target_properties(Polly PROPERTIES
  INTERFACE_LINK_LIBRARIES "PollyISL;LLVM"
)
